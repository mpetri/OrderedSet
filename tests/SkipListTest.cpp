...
{
    SkipList* list = new SkipList(false);
...
TEST(SkipList , Insert)
{
    ...
    CHECK(head->data == 1); head=head->next[0];
    CHECK(head->data == 2); head=head->next[0];
    CHECK(head->data == 5); head=head->next[0];
    CHECK(head->data ==24); head=head->next[0];
    CHECK(head->data ==32); head=head->next[0];
    CHECK(head->data ==51); head=head->next[0];
    CHECK(head->data ==57); head=head->next[0];
    CHECK(head->data ==61); head=head->next[0];
    CHECK(head == NULL);
